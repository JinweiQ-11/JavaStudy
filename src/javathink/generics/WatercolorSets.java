package javathink.generics;//: generics/WatercolorSets.java

import javathink.generics.watercolors.Watercolors;

import java.util.EnumSet;
import java.util.Set;

import static javathink.generics.watercolors.Watercolors.*;
import static javathink.net.mindview.util.Print.print;
import static javathink.net.mindview.util.Sets.*;
