package javathink.containers;//: containers/CollectionDataGeneration.java
// Using the Generators defined in the Arrays chapter.
import javathink.net.mindview.util.CollectionData;
import javathink.net.mindview.util.RandomGenerator;
