package javathink.containers;//: containers/Maps.java
// Things you can do with Maps.

import javathink.net.mindview.util.CountingMapData;

import java.util.*;
import java.util.concurrent.ConcurrentHashMap;

import static javathink.net.mindview.util.Print.print;
import static javathink.net.mindview.util.Print.printnb;
