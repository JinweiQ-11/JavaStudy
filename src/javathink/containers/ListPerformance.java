package javathink.containers;//: containers/ListPerformance.java
// Demonstrates performance differences in Lists.
// {Args: 100 500} Small to keep build testing short
import javathink.net.mindview.util.CountingGenerator;
import javathink.net.mindview.util.CountingIntegerList;
import javathink.net.mindview.util.Generated;
