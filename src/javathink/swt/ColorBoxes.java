package javathink.swt;//: swt/ColorBoxes.java
// SWT translation of Swing ColorBoxes.java.
import javathink.net.mindview.util.DaemonThreadPoolExecutor;
import javathink.swt.util.SWTApplication;
import javathink.swt.util.SWTConsole;
